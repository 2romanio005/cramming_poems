...
class PoemList {
  ...
  Poem _getWelcomePlugPoem() {
    ...
    return Poem(
      text: [
        "    Чтобы добавить стихотворение, откройте меню в левом верхнем углу (три полосочки) и нажмите на кнопочку '+'.",
        "    Двойной клик по тексту позволяет редактировать стихотворение.",
  ...
  newPoemFile() {
    ...
    addPoemFile(PoemFile(
      poem: Poem(
        title: "Стихотворение $nextNumberInFileName",
      ),
